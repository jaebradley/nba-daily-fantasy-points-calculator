...
function main() {
  ...
  do
    local input_file_path="${current_directory}/data/boxscores/${input_file_name}.json"
    ...
    local expected_output_file_path="${current_directory}/data/expected/parse boxscore data/${input_file_name}.csv"
